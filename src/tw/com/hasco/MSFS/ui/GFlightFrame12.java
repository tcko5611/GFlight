...
public class GFlightFrame12 extends javax.swing.JFrame {
     ...
     */
    public GFlightFrame12() throws IOException {
        initComponents();
    ...
    private void recordMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recordMenuItemActionPerformed
        ...
        int rVal = c.showOpenDialog(GFlightFrame12.this);
    ...
    private void playMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playMenuItemActionPerformed
        ...
        if (rVal == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Logger.getLogger(GFlightFrame12.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GFlightFrame12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        GFlightFrame12 dataFrame = new GFlightFrame12();
