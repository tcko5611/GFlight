...
public class GFlightFrame extends javax.swing.JFrame {
    ...
    public GFlightFrame() throws IOException {
        ...
        ctrlFrame = new CtrlFrame();
        picthFrame = new PitchFrame();
        rollFrame = new RollFrame();
        yawFrame = new YawFrame();
    ...
    private void disableAll() {
        ...
        this.llaMenuItem.setEnabled(false);
        this.ctrlMenuItem.setEnabled(false);
        ...
        this.plot6MenuItem.setEnabled(false);
    ...
    private void initComponents() {
        ...
        llaMenuItem = new javax.swing.JMenuItem();
        ctrlMenuItem = new javax.swing.JMenuItem();
        ...
        plot6MenuItem = new javax.swing.JMenuItem();
        ...
        llaMenuItem.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        llaMenuItem.setText("飛航資訊LLA");
        llaMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                llaMenuItemActionPerformed(evt);
            }
        });
        graphicMenu.add(llaMenuItem);

        ctrlMenuItem.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        ctrlMenuItem.setText("飛行操控Ctrl");
        ctrlMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ctrlMenuItemActionPerformed(evt);
            }
        });
        graphicMenu.add(ctrlMenuItem);
        ...
        plot6MenuItem.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        plot6MenuItem.setText("數值圖Plot6");
        plot6MenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                plot6MenuItemActionPerformed(evt);
            }
        });
        graphicMenu.add(plot6MenuItem);
    ...
    private void ctrlMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ctrlMenuItemActionPerformed
        // TODO add your handling code here:
        ctrlFrame.setVisible(true);
    }//GEN-LAST:event_ctrlMenuItemActionPerformed

    private void pitchMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pitchMenuItemActionPerformed
        // TODO add your handling code here:
        this.picthFrame.setVisible(true);
    ...
    private void rollMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rollMenuItemActionPerformed
        // TODO add your handling code here:
        this.rollFrame.setVisible(true);
    ...
    private void recordMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recordMenuItemActionPerformed
        ...
        int rVal = c.showOpenDialog(GFlightFrame.this);
    ...
    private void llaMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_llaMenuItemActionPerformed
        // TODO add your handling code here:
        llaFrame.setVisible(true);
    }//GEN-LAST:event_llaMenuItemActionPerformed

    private void plot6MenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plot6MenuItemActionPerformed
        // TODO add your handling code here:
    ...
    private void setDataGetter() {
        ...
        dataGetter.addObserver(ctrlFrame);
        dataGetter.addObserver(picthFrame);
        dataGetter.addObserver(rollFrame);
        dataGetter.addObserver(yawFrame);
        dataGetter.addObserver(traceFrame);
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GFlightFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        GFlightFrame dataFrame = new GFlightFrame();
    ...
    private javax.swing.JMenuItem ctrlMenuItem;
    ...
    private javax.swing.JMenuItem llaMenuItem;
    ...
    private javax.swing.JMenuItem plot6MenuItem;
